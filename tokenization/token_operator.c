...
void token_operator_init(void) {
    ...
    operator_name_to_str_set(greater, ">");
    operator_name_to_str_set(double_greater, ">>");
    operator_name_to_str_set(double_greater_equals, ">>=");
    operator_name_to_str_set(greater_equals, ">=");
    ...
    name_of_set(greater, "greater");
    name_of_set(double_greater, "double_greater");
    name_of_set(double_greater_equals, "double_greater_equals");
    name_of_set(greater_equals, "greater_equals");
